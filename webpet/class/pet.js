...
function catchUpState() {
    ...
    if (walk.current == 0) {
        ...
        document.getElementById("pet").src = "webpet/img/Walk.gif"
...
function attackState() {
    ...
    if (attack.current == 0) {
        // 调整播放的动画
        document.getElementById("pet").src = "webpet/img/Attack.gif"
    ...
    // 结束播放攻击动画，改变对应状态，播放待机动画。
        ...
        isIdle = true;
        attack.current = 0;
        document.getElementById("pet").src = "webpet/img/Idle.gif"
        pet.style.width = 50 + "px"
...
function clickState() {
    // 准备播放受击动画
    if (click.current == 0) {
        document.getElementById("pet").src = "webpet/img/Hit.gif"
